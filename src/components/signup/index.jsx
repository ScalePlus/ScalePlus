  ...
  const receiveMessage = (event) => {
    if (event.origin === window.location.origin) {
      ...
      if (event.data.success && event.data.from === "Linked In") {
        ...
        setLinkedinId(success.id);
        setFname(success.localizedFirstName);
        setLname(success.localizedLastName);
        setEmail(success.emailAddress);
        setGoogleId(null);
        popup && popup.close();
      }
    }
          ...
          <div className="content-container">
                ...
                <GoogleLogin
                  ...
                  onSuccess={(response) => {
                    if (response && response.profileObj) {
                      ...
                      setFname(response.profileObj.familyName);
                      setLname(response.profileObj.givenName);
            ...
            <Form noValidate validated={validated} onSubmit={onSignup}>
              ...
              <Row style={{ marginTop: "-2rem" }}>
                <Col>
                  {!activeTab && validated ? (
                    <Form.Text className="invalid-text text-left">
                      {t("role_error")}
                    </Form.Text>
                  ) : null}
                </Col>
